  ...
  async function carbonScore_callGPT(props) {
    ...
    setIsLoading(true);
      ...
      const responseGPT = await fetch('http://localhost:8000/api/chatGPT', {
        ...
        body: JSON.stringify({
          prompt: "Based on my carbon emissions from driving "+ totalMiles +" in a "+ currModel + " "+ currMake +" from the past week which is "+ datacarbon.data.co2e_kg +"co2e kg tell me whether that is high or low on average and tell me steps to improve in 100 words",
        }),
      });
